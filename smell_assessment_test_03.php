...
body {background-color: #DCDCDC;}
  ...
  <a href="smell_assessment_test_02.php">
  <form method="POST" action="smell_assessment_test_02.php">
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:88.35%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['smell_assessment_test_03_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          <h2><b><?php echo $lang['smell_assessment_test_03_subtitle']."<br />"; ?></b></h2>
		  <br>
		  <h4><?php echo $lang['smell_assessment_test_03_question_1']."<br/>"; ?> <?php echo $lang['smell_assessment_test_03_question_2']; ?></h4>
        </ul>
		<br>
		<h4><?php echo $lang['smell_assessment_test_03_subtitle_answers']; ?></h4>
		<form action="smell_assessment_test_04.php" method="POST">	
		
		<div class="checkbox">
			<label><input type="radio" name="smell_assessment_test_03" value="<?php echo $lang['easly_smell']; ?>"><?php echo $lang['smell_assessment_test_03_question_Number_1']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="radio" name="smell_assessment_test_03" value="<?php echo $lang['faint_smell']; ?>"><?php echo $lang['smell_assessment_test_03_question_Number_2']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="radio" name="smell_assessment_test_03" value="<?php echo $lang['no_smell']; ?>"><?php echo $lang['smell_assessment_test_03_question_Number_3']; ?></label>
		</div>
