...
body {background-color: #DCDCDC;}
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
   <a href="report_agreement.php">
  <form method="POST" action="report_agreement.php">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
		...
		<form id="form1" action="report_covid19_2.php" method="POST">
		
			<div class="checkbox">
				<label><input type="radio" id="report_covid19_type"  name="report_covid19_type" value="<?php echo $lang['report_covid19_question_n1_value']; ?>"><?php echo $lang['report_covid19_question_n1']; ?></label>
			</div>
			
			<div class="checkbox">
				<label><input type="radio" id="report_covid19_type"  name="report_covid19_type" value="<?php echo $lang['report_covid19_question_n2_value']; ?>"><?php echo $lang['report_covid19_question_n2']; ?></label>
			</div>
			
			<div class="checkbox">
				<label><input type="radio" id="report_covid19_type"  name="report_covid19_type" value="<?php echo $lang['report_covid19_question_n3_value']; ?>"><?php echo $lang['report_covid19_question_n3']; ?></label>
			</div>
			
			<div class="checkbox">
				<label><input type="radio" id="report_covid19_type"  name="report_covid19_type" value="<?php echo $lang['report_covid19_question_n4_value']; ?>"><?php echo $lang['report_covid19_question_n4']; ?></label>
			</div>
