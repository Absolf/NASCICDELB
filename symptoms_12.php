...
body {background-color: #DCDCDC;}
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
   <a href="symptoms_11.php">
  <form method="POST" action="symptoms_11.php">
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:54.15%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['symptoms_12_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          <h2><b><?php echo $lang['symptoms_12_sub_title']; ?> </b></h2>
		  <br>
		  <h4><?php echo $lang['symptoms_12_question']; ?></h4>
        </ul>
		<br>
		<form action="symptoms_13.php" method="POST">	
		
		<div type="checkbox"> 
			<select name="symptoms_12_feel_dizzy" id="symptoms_12_feel_dizzy" data-role="slider">
