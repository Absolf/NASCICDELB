...
body {background-color: #DCDCDC;}
  ...
  <a href="covid_19_exposure.php">
  <form method="POST" action="covid_19_exposure.php">
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:79.8%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['smell_test_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          
		  <br>
		  <h4><?php echo $lang['smell_test_question_1']."<br/>"; ?> <?php echo $lang['smell_test_question_2']; ?></h4>
        </ul>
		<br>
		<form action="smell_assessment_test_01.php" method="POST">	
		
		<div class="checkbox">
			<label><input type="checkbox" name="smell_test" value="<?php echo $smell_test_n1; ?>"><?php echo $lang['smell_test_question_number_1']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="smell_test" value="<?php echo $smell_test_n2; ?>"><?php echo $lang['smell_test_question_number_2']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="smell_test" value="<?php echo $smell_test_n3; ?>"><?php echo $lang['smell_test_question_number_3']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="smell_test" value="<?php echo $smell_test_n4; ?>"><?php echo $lang['smell_test_question_number_4']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="smell_test" value="<?php echo $smell_test_n5; ?>"><?php echo $lang['smell_test_question_number_5']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="smell_test" value="<?php echo $smell_test_n6; ?>"><?php echo $lang['smell_test_question_number_6']; ?></label>
		</div>
