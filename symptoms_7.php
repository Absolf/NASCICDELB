...
body {background-color: #DCDCDC;}
  ...
  <a href="symptoms_6.php">
  <form method="POST" action="symptoms_6.php">
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:39.9%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['symptoms_7_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          <h2><b><?php echo $lang['symptoms_7_sub_title']; ?> </b></h2>
		  <br>
		  <h4><?php echo $lang['symptoms_7_question']; ?></h4>
        </ul>
		<br>
		<form action="symptoms_8.php" method="POST">	
		
		<div type="checkbox"> 
			<select name="symptoms_7_diarrhea" id="symptoms_7_diarrhea" data-role="slider">
