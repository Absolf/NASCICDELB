...
body {background-color: #DCDCDC;}
  ...
  <a href="symptoms_18.php">
  <form method="POST" action="symptoms_18.php">
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:74.1%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['covid_19_region_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          
		  <br>
		  <h4><?php echo $lang['covid_19_region_question_1']."<br/>"; ?> <?php echo $lang['covid_19_region_question_2']."<br/>"; ?> <?php echo $lang['covid_19_region_question_3']; ?></h4>
        </ul>
		<br>
		<form action="covid_19_exposure.php" method="POST">	
		
		<div class="checkbox">
			<label><input type="checkbox" name="covid_19_region" value="<?php echo $covid19_region_n1; ?>"><?php echo $lang['covid_19_region_question_number_1']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="covid_19_region" value="<?php echo $covid19_region_n2; ?>"><?php echo $lang['covid_19_region_question_number_2']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="covid_19_region" value="<?php echo $covid19_region_n3; ?>"><?php echo $lang['covid_19_region_question_number_3']; ?></label>
		</div>
