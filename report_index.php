...
body {background-color: #DCDCDC;}
  ...
  <!-- Progress Bar (100%/5pages = 20) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:20%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['report_index_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          <b><li> <?php echo $lang['report_index_question'];?> </li><b>
        </ul>
		<br><br><br>
		
		
		<form action="report_agreement.php" method="POST">
		
			<div class="input-group mb-3">
				<input type="date"  id="date_report" name="date_report"  class="form-control" placeholder="<?php echo $lang['report_index_placeholder_n1']; ?>" aria-label="Username" aria-describedby="basic-addon1" required>
			</div> 
			
			<div class="input-group mb-3">
				<input type="text" onblur="checkLength(this)"  maxlength="6" id="report_test_id" name="report_test_id"  class="form-control" placeholder="<?php echo $lang['report_index_placeholder_n2']; ?>" aria-label="Username" aria-describedby="basic-addon1">
			</div> 
				
				<button type="submit" class="btn btn-warning" id="submit" style="display:none;" ><?php echo $lang['next']; ?></button>
		</form>
		<p><?php echo $lang['report_index_placeholder_info'];?><p>
		<br><br>
