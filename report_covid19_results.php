<?php
	...
	$report_covid19_diagnosis = isset($_POST['report_covid19_diagnosis']) ? $_POST['report_covid19_diagnosis'] : "";
	$_SESSION['AUX_report_covid19_diagnosis'] = $report_covid19_diagnosis;
...
body {background-color: #DCDCDC;}
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
   <a href="report_covid19_2.php">
  <form method="POST" action="report_covid19_2.php">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
		...
		<p>image</p>
		<h5><?php echo $lang['report_covid19_message'];?></h5>
		<br>
		<form action="report_clear_session.php" method="POST">
			<input type="submit" class="btn btn-success" value="<?php echo $lang['exit'];?>" />
		</form>
		...
		report_covid19_diagnosis = <?php echo $report_covid19_diagnosis = isset($_POST['report_covid19_diagnosis']) ? $_POST['report_covid19_diagnosis'] : ""; ?><br>
...
$sql = "INSERT INTO report (date, report_test_id, covid19_type, covid19_diagnosis) VALUES ('$date_report', '$report_test_id', '$report_covid19_type', '$report_covid19_diagnosis')";
