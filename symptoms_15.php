...
body {background-color: #DCDCDC;}
  ...
  <a href="symptoms_14.php">
  <form method="POST" action="symptoms_14.php">
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:62.7%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['symptoms_15_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          <h2><b><?php echo $lang['symptoms_15_sub_title']; ?> </b></h2>
		  <br>
		  <h4><?php echo $lang['symptoms_15_question']; ?></h4>
        </ul>
		<br>
		<form action="symptoms_16.php" method="POST">	
		
		<div type="checkbox"> 
			<select name="symptoms_15_lack_of_appetite" id="symptoms_15_lack_of_appetite" data-role="slider">
