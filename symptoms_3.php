<?php
	...
	$symptoms_3_question_n1 = 1;
	$symptoms_3_question_n2 = 2;
	$symptoms_3_question_n3 = 3;
	$symptoms_3_question_n4 = 4;
...
body {background-color: #DCDCDC;}
  ...
  <a href="symptoms_2.php">
  <form method="POST" action="symptoms_2.php">
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:28.5%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['symptoms_3_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          <h2><b><?php echo $lang['symptoms_3_question_1']."<br />"; ?> <?php echo $lang['symptoms_3_question_2']."<br />"; ?> <?php echo $lang['symptoms_3_question_3']; ?> </b></h2>
		  
        </ul>
		<br>
		<form action="symptoms_4.php" method="POST">	
			
			
		<div class="checkbox">
			<label><input type="checkbox" name="symptoms_3" value="<?php echo $symptoms_3_question_n1; ?>"><?php echo $lang['symptoms_3_question_number_1']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="symptoms_3" value="<?php echo $symptoms_3_question_n2; ?>"><?php echo $lang['symptoms_3_question_number_2']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="symptoms_3" value="<?php echo $symptoms_3_question_n3; ?>"><?php echo $lang['symptoms_3_question_number_3']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="symptoms_3" value="<?php echo $symptoms_3_question_n4; ?>"><?php echo $lang['symptoms_3_question_number_4']; ?></label>
		</div>
