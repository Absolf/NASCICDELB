<?php
	...
	$covid_19_region = isset($_POST['covid_19_region'])? $_POST['covid_19_region']:0;
	...
	$covid19_exposure_n1 = 1;
	$covid19_exposure_n2 = 2;
	$covid19_exposure_n3 = 3;
	$covid19_exposure_n4 = 4;
	$covid19_exposure_n5 = 5;
...
body {background-color: #DCDCDC;}
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
   <a href="covid_19_region.php">
  <form method="POST" action="covid_19_region.php">
	...
	<input type="hidden" value="<?php echo $covid_19_region= (!empty($_POST['covid_19_region'])) ? $_POST['covid_19_region'] : 0; ?>"  id="covid_19_region" name="covid_19_region" >
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:76.95%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['covid_19_exposure_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          
		  <br>
		  <h4><?php echo $lang['covid_19_exposure_question_1']."<br/>"; ?> <?php echo $lang['covid_19_exposure_question_2']; ?></h4>
        </ul>
		<br>
		<form action="smell_test.php" method="POST">	
		
		<div class="checkbox">
			<label><input type="radio" id="covid_19_exposure"  name="covid_19_exposure" value="<?php echo $covid19_exposure_n1; ?>"><?php echo $lang['covid_19_exposure_question_number_1']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="radio" id="covid_19_exposure"  name="covid_19_exposure" value="<?php echo $covid19_exposure_n2; ?>"><?php echo $lang['covid_19_exposure_question_number_2']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="radio" id="covid_19_exposure"  name="covid_19_exposure" value="<?php echo $covid19_exposure_n3; ?>"><?php echo $lang['covid_19_exposure_question_number_3']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="radio" id="covid_19_exposure"  name="covid_19_exposure" value="<?php echo $covid19_exposure_n4; ?>"><?php echo $lang['covid_19_exposure_question_number_4']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="radio" id="covid_19_exposure"  name="covid_19_exposure" value="<?php echo $covid19_exposure_n5; ?>"><?php echo $lang['covid_19_exposure_question_number_5']; ?></label>
		</div>
		...
		<input type="hidden" value="<?php echo $symptoms_17_inflammation_eyes = $_REQUEST['symptoms_17_inflammation_eyes']; ?>"  id="symptoms_17_inflammation_eyes" name="symptoms_17_inflammation_eyes" >
		<input type="hidden" value="<?php echo $symptoms_18_vision_blurred = $_REQUEST['symptoms_18_vision_blurred']; ?>"  id="symptoms_18_vision_blurred" name="symptoms_18_vision_blurred" >
		<input type="hidden" value="<?php echo $covid_19_region = $_SESSION['AUX_covid_19_region']; ?>"  id="covid_19_region" name="covid_19_region" >
