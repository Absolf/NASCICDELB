...
if(isset($_POST['btn-signup']))
{
 ...
 $stmt = $reg_user->runQuery("SELECT * FROM tbl_super_admin WHERE userEmail=:email_id");
 ...
 else
 {
  ...
  {   
   ...
   $message = "     
      Hello $uname,
      <br /><br />
      Welcome to Nasum TECH<br/>
      To complete your registration  please , just click following link<br/>
      <br /><br />
      <a href='http://192.168.0.106/nasumtech/super_admin/verify.php?id=$id&code=$code'>Click HERE to Activate :)</a>
      <br /><br />
      Thanks,";
