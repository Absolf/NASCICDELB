...
if(isset($_POST['btn-submit']))
{
 ...
 $stmt = $user->runQuery("SELECT userID FROM tbl_super_admin WHERE userEmail=:email LIMIT 1");
 ...
 if($stmt->rowCount() == 1)
 {
  ...
  $stmt = $user->runQuery("UPDATE tbl_super_admin SET tokenCode=:token WHERE userEmail=:email");
  ...
  $message= "
       ...
       <br /><br />
       <a href='http://192.168.0.106/nasumtech/super_admin/resetpass.php?id=$id&code=$code'>click here to reset your password</a>
       <br /><br />
       thank you :)
       ";
