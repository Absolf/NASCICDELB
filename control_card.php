<?php
	...
	$_SESSION['AUX_smell_assessment_test_05'] = $smell_assessment_test_05;
...
body {background-color: #DCDCDC;}
  ...
  <a href="smell_assessment_test_05.php">
  <form method="POST" action="smell_assessment_test_05.php">
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:96.9%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['control_card_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          
		  <br>
		  <h4><?php echo $lang['control_card_question']; ?></h4>
        </ul>
		<br>
		...
		<div class="checkbox">
			<label><input type="radio" name="control_card" value="<?php echo $control_card_n1; ?>"><?php echo $lang['card1']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="radio" name="control_card" value="<?php echo $control_card_n2; ?>"><?php echo $lang['card2']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="radio" name="control_card" value="<?php echo $control_card_n3; ?>"><?php echo $lang['card3']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="radio" name="control_card" value="<?php echo $control_card_n4; ?>"><?php echo $lang['card4']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="radio" name="control_card" value="<?php echo $control_card_n5; ?>"><?php echo $lang['card5']; ?></label>
		</div>
		...
		<!-- testing -->
		<input type="hidden" value="<?php echo $_SESSION['AUX_test_id']; ?>"  id="test_id" name="test_id" >	
		<input type="hidden" value="<?php echo $lat = $_REQUEST['lat']; ?>"  id="lat" name="lat" >	
		<input type="hidden" value="<?php echo $long = $_REQUEST['long']; ?>"  id="long" name="long" >
		<input type="hidden" value="<?php echo $basic_info_id = $_SESSION['AUX_basic_info_id'] ?>"  id="basic_info_id" name="basic_info_id" >
		<input type="hidden" value="<?php echo $sex = $_REQUEST['sex']; ?>"  id="sex" name="sex" > 
		<input type="hidden" value="<?php echo $risk_factors = $_REQUEST['risk_factors']; ?>"  id="risk_factors" name="risk_factors" >
		<input type="hidden" value="<?php echo $research_factor = $_REQUEST['research_factor']; ?>"  id="research_factor" name="research_factor" >
		<input type="hidden" value="<?php echo $heart_rate = $_REQUEST['heart_rate']; ?>"  id="heart_rate" name="heart_rate" >
