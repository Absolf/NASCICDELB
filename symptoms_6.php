...
body {background-color: #DCDCDC;}
  ...
  <a href="symptoms_5.php">
  <form method="POST" action="symptoms_5.php">
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:37.05%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['symptoms_6_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          <h2><b><?php echo $lang['symptoms_6_sub_title']; ?> </b></h2>
		  <br>
		  <h4><?php echo $lang['symptoms_6_question']; ?></h4>
        </ul>
		<br>
		<form action="symptoms_7.php" method="POST">	
		
		<div type="checkbox"> 
			<select name="symptoms_6_headache" id="symptoms_6_headache" data-role="slider">
