<?php
	...
	$research_factors_question_n1 = 1;
	$research_factors_question_n2 = 2;
	$research_factors_question_n3 = 3;
	$research_factors_question_n4 = 4;
...
body {background-color: #DCDCDC;}
  ...
  <a href="risk_factors.php">
  <form method="POST" action="risk_factors.php">
  ...
  <!-- Progress Bar (100%/35pages = 2.8) -->
	<div class="w3-container">
		<div class="w3-border">
			<div class="w3-yellow" style="height:24px;width:17.1%"></div>
		</div>
	</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h1><b><?php echo $lang['research_factors_title']."<br />"; ?></b></h1>
        <br><br><br>
		<p>IMAGE</p>
        <ul class="list-unstyled">
          <h2><b><?php echo $lang['reaech_factors_question_1']."<br />"; ?> <?php echo $lang['reaech_factors_question_2']; ?> </b></h2>
		  
        </ul>
		<br>
		<form action="research_factors_2.php" method="POST">	
			
			
		<div class="checkbox">
			<label><input type="checkbox" name="research_factor" value="<?php echo $research_factors_question_n1; ?>"><?php echo $lang['reaech_factors_question_number_1']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="research_factor" value="<?php echo $research_factors_question_n2; ?>"><?php echo $lang['reaech_factors_question_number_2']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="research_factor" value="<?php echo $research_factors_question_n3; ?>"><?php echo $lang['reaech_factors_question_number_3']; ?></label>
		</div>
		<div class="checkbox">
			<label><input type="checkbox" name="research_factor" value="<?php echo $research_factors_question_n4; ?>"><?php echo $lang['reaech_factors_question_number_4']; ?></label>
		</div>
		...
		<input type="hidden" value="<?php echo $basic_info_id = $_REQUEST['basic_info_id']; ?>"  id="basic_info_id" name="basic_info_id" >
		<input type="hidden" value="<?php echo $sex = $_REQUEST['sex']; ?>"  id="sex" name="sex" > 
		<input type="hidden" value="<?php echo $$risk_factors = isset($_POST['risk_factors'])? $_POST['risk_factors']:0; ?>"  id="risk_factors" name="risk_factors" >
